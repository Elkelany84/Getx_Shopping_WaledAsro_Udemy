...
//                   image: categoryController.productList[index].image,
//                   price: categoryController.productList[index].price,
//                   rating: categoryController.productList[index].rating.rate,
//                   productId: categoryController.productList[index].id,
//                   productModels: categoryController.productList[index],
//                   onTap: () {
